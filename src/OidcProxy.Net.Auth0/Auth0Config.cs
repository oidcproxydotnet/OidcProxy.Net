...
public class  Auth0Config
{
    ...
    public bool Validate(out IEnumerable<string> errors)
    {
        ...
        {
            results.Add($"GCN-O-e9ba6693bb0e: Unable to start GoCloudNative.Bff. \"{ClientId}\" is not a valid client_id. " +
        ...
        {
            results.Add($"GCN-O-427413a281d9: Unable to start GoCloudNative.Bff. \"{ClientSecret}\" is not a valid client_secret. " +
        ...
        {
            results.Add($"GCN-A-fe95cf8c11ae: Unable to start GoCloudNative.Bff. \"{Audience}\" is not a valid audience. " +
        ...
        {
            results.Add($"GCN-A-1701a00d8c56: Unable to start GoCloudNative.Bff. \"{Domain}\" is not a valid Auth0 Domain. " +
