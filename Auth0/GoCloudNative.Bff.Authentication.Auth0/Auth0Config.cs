...
public class  Auth0Config
{
    ...
    public bool Validate(out IEnumerable<string> errors)
    {
        ...
        {
            results.Add("GCN-A-fe95cf8c11ae: Unable to start GoCloudNative.Bff. Invalid audience. " +
        ...
        {
            results.Add("GCN-A-1701a00d8c56: Unable to start GoCloudNative.Bff. Invalid Auth0 Domain. " +
